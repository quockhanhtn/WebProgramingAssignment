...
<div class="container">
    <div class="row">
        ...
        <div class="col-10 text-center">
            ...
            <p>Thank you for your order of <%= quantity %> widgets, <b><i><%= customerName %></i></b></p>
            <p>At $<%= pricePerUnit %>, your bill will be $<%= totalCost %></p>
            <p>You will shortly receive an email confirmation at <%= customerEmail %>.</p>
