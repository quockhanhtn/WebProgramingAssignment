...
<head>
    ...
    <title>WP - Assignment 3 - Lam Quoc Khanh - 18110304</title>
            ...
            <form action="order-reply" method="get" class="container">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" min="1" class="input-focus" name="order-quantity" id="order-quantity"/>
                        </td></tr>
                    <tr>
                        <td class="text-right td-label">
                        ...
                        <td>
                            <input type="text" class="input-focus" name="customer-name" id="customer-name">
                        </td></tr>
                    <tr>
                        <td class="text-right td-label">
                        ...
                        <td>
                            <input type="email" class="input-focus" name="customer-email" id="customer-email">
                        </td></tr>
                    <tr>
