...
<head>
    ...
    <title>WP - Assignment 2.1 - Lam Quoc Khanh - 18110304</title>
            ...
            <form action="order-reply.jsp" method="get" class="container">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" min="1" class="input-focus" name="order-quantity" id="order-quantity" required/>
                        </td></tr>
                    <tr>
                        <td class="text-right td-label">
                        ...
                        <td>
                            <input type="text" class="input-focus" name="customer-name" id="customer-name" required>
                        </td></tr>
                    <tr>
                        <td class="text-right td-label">
                        ...
                        <td>
                            <input type="email" class="input-focus" name="customer-email" id="customer-email" required>
                        </td></tr>
                    <tr>
